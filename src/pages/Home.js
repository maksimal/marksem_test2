  ...
  return (
    <main>
      ...
      <ScrollAnimation
        ...
        <CompanyPresentation
          title={
            <h1 className="company-presentation__title title--main">
              БУДУЙТЕ НОВІ МОЖЛИВОСТІ З<br/>MARKSEM.
            </h1>
          }
          info={
            <div className="company-presentation__info">
              <p className="f24">Інвестуйте, дбайте про майбутнє та насолоджуйтесь життям вже сьогодні.</p>
              <p className="f24" style={{paddingTop: '50px'}}>Будуйте нові можливості з MARKSEM.</p>
            </div>
          }
          img="./img/houses.png"
          action={true}
      ...
      <ScrollAnimation
        ...
        >
          <p>Ми виробляємо затишні та комфортні будинки, орієнтуючись на сучасні технології, функціональність та високу якість.</p>
          <p>Будинки MARKSEM можуть стати для вас заміським будинком або власним бізнесом.</p>
          <p>Розмістити такий будинок ви можете на своїй ділянці або в одному з наших парків, що мають гарні краєвиди, готельну інфраструктуру та сервіс. Таким чином, ви будете мати, куди поїхати на вихідні, де провести відпустку чи просто виїхати за місто, як тільки виникне потреба. А решту часу будинок буде працювати на вас.</p>
          <p>Вам не потрібно турбуватись про обслуговування: усі парки MARKSEM — це комплекс сервісів високого рівня.</p>
          <p>Ми пропонуємо вам стати не тільки власником комфортного, затишного будинку для відпочинку та життя, а й максимально ефективно використовувати його під час вашої відсутності — як бізнес оренди житла.</p>
          <p>З великою увагою до деталей ми турбуємось про все: від обслуговування до керування.</p>
          <p>Розуміючи переваги, які надають сучасні технології, ми розробили CRM- систему, з якою власник будинку може керувати своїм майном та коштами.</p>
        </ImageTextBlock>
      </ScrollAnimation>
