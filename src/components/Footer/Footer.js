    ...
    return(
        <footer>
                <div className='links-wrapper'>
                    <div className="logo-wrapper">
                        <div className="logo">
                            ...
                            <p className="description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui odio laboriosam rem dicta voluptate possimus.</p>
                        </div>
                    </div>
                    <div className="links-section">
                        <Link to={'/whymarksem'} className="title-links">why marksem</Link>
                    ...
                    <div className="links-section">
                        <Link to={'/houses'} className="title-links">houses</Link>
                    ...
                    <div className="links-section">
                        <Link to={'/investments'} className="title-links">investments</Link>
                    ...
                    <div className="links-section">
                        <Link to={'/contacts'} className="title-links">contacts</Link>
                ...
                <div className="credentials-wrapper">
                    <p className="credentials-text">COPYRIGHT © 2020 MARKSEM. ALL RIGHTS RESERVED.</p>
