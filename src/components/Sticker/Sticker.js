...
const Sticker = ({ title, text }) => {
  return (
      ...
      <div className="sticker">
        ...
        <svg id="sticker" width="395" height="429" viewBox="0 0 395 429" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            <filter id="filter0_d" x="0" y="0" width="395" height="429" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
