...
import "./ConfirmHouseForm.scss"
import { useState, Fragment } from 'react';

// !!! Форма просто скопирована из другого компонента. Форма и кнопка сабмит никак не связаны сейчас. Надо доделать, возможно записывать в редакс имя и телефон.

const ConfirmHouseForm = ({
  actionOnClick
}) => {
  ...
  return (
    <div className="confirm-house-form">
...
export default ConfirmHouseForm;
